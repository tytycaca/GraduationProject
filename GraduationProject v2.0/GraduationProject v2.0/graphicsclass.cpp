...
bool GraphicsClass::Initialize(int screenWidth, int screenHeight, HWND hwnd)
{
	...
	result = m_Model[0]->Initialize(m_D3D->GetDevice(), (char*)"../GraduationProject v2.0/Floor.txt",
		(WCHAR*)L"../GraduationProject v2.0/Texture/boxTexture.jpg");
	if (!result)
	{
	...
	result = m_Model[1]->Initialize(m_D3D->GetDevice(), (char*)"../GraduationProject v2.0/Querychan_Shizuoka_Body.txt",
		(WCHAR*)L"../GraduationProject v2.0/Texture/Tex_Body_Shizuoka.png");
	if (!result)
	{
		MessageBox(hwnd, L"Could not initialize the model object.", L"Error", MB_OK);
		return false;
	...
	result = m_Model[2]->Initialize(m_D3D->GetDevice(), (char*)"../GraduationProject v2.0/Querychan_Shizuoka_Face.txt",
		(WCHAR*)L"../GraduationProject v2.0/Texture/Tex_Face_Defo_Shizuoka.png");
	if (!result)
	{
		MessageBox(hwnd, L"Could not initialize the model object.", L"Error", MB_OK);
		return false;
	...
	result = m_Model[3]->Initialize(m_D3D->GetDevice(), (char*)"../GraduationProject v2.0/Querychan_Shizuoka_Hat.txt",
		(WCHAR*)L"../GraduationProject v2.0/Texture/Tex_Hat_Shizuoka.png");
	if (!result)
	{
		MessageBox(hwnd, L"Could not initialize the model object.", L"Error", MB_OK);
		return false;
